...
from SCRN.utils.data import test_dataset
...
def apply_SCRN(image_root):
    ...
    test_loader = test_dataset(image_root, image_size=352, n_images=len(os.listdir(image_root)))
    ...
    with torch.no_grad():
        for i in range(test_loader.size):
            ...
            infos[i] = {"path": new_path, "size": prev_size, "preproc_image": image}
